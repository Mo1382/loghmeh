...
export default function FollowBtn({ type = "lg" }) {
  return (
    <button
      className={`inline-flex items-center transition-colors bg-red-500 text-white hover:bg-red-hover  ${typesClassName[type]} `}
    >
