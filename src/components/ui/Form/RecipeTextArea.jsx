const inputClassName =
  "h-[142px] py-12 w-full rounded-[10px] border border-neutral-5 bg-neutral-1 px-14 text-14 font-normal text-neutral-8 outline-none placeholder:text-neutral-6 focus:border-red-400 md:rounded-xl md:h-[170px]  md:text-15 lg:h-[186px] lg:text-16 lg:px-16";
...
export default function RecipeTextArea({
  inputId,
  label,
  name,
  placeholder,
