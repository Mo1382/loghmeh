...
export default function Test2({
  ...
  return (
    <div
      className={`flex flex-row justify-between items-center text-neutral-1 rounded-xl md:rounded-[14px] shadow-card mx-auto min-w-[346px] max-w-[calc(100% - 48px)] md:max-w-[520px] pr-16 pl-14 py-14 ${isSuccess ? "bg-green-notif" : "bg-red-notif"}`}
    >
